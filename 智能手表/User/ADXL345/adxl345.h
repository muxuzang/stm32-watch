...
/***************根据自己需求更改****************/
// ADXL345引脚宏定义
#define ADXL345_SCL_PORT  			GPIOC
#define ADXL345_SCL_PIN					GPIO_Pin_7
#define ADXL345_SCL_GPIO_CLK  	RCC_APB2Periph_GPIOC
#define ADXL345_SDA_PORT  			GPIOC
#define ADXL345_SDA_PIN					GPIO_Pin_6
#define ADXL345_SDA_GPIO_CLK   	RCC_APB2Periph_GPIOC

#define ADXL345_IIC_SCL    	PCout(7) //SCL
#define ADXL345_IIC_SDA    	PCout(6) //SDA	 
#define ADXL345_READ_SDA		PCin(6)  //输入SDA 
...
#define COUNTER_MAX_VALUE 8000  // 模拟的最大计数数值，相当于一个时间周期范围上限
#define MIN_STEP_COUNTER_VALUE 5  // 模拟的最小步数时间间隔对应的计数数值，相当于时间间隔下限
#define MAX_STEP_COUNTER_VALUE 8000  // 模拟的最大步数时间间隔对应的计数数值，相当于时间间隔上限
